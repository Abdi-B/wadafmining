...
const Contact = () => {
  ...
  const onSubmitHandler = async (e: any) => {
    ...
    if (name.current &&  email.current && phone.current && message.current ) {
      name.current.value = '';
      email.current.value = '';
      phone.current.value = '';
        ...
        <div className="-mx-4 flex flex-wrap lg:justify-between">
          <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div className="mb-12 max-w-[570px] lg:mb-0">
              ...
              <h3 className="text-primary mb-4 block text-base font-semibold dark:text-white">
                GET IN TOUCH WITH US
              </h3>
              <p className="text-body-color mb-9 text-base leading-relaxed dark:text-white">
                Our team is always available to answer any questions and provide
                support. Contact us to learn more about our services and how we
                can help your business grow.
              </p>
              <div className="mb-8 flex w-full max-w-[370px]">
                <div className="bg-primary text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px] dark:text-white">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                ...
                <div className="w-full">
                  ...
                  <p className="text-body-color text-base dark:text-white">
                    Addis Ababa,Sheger Building 6th Floor , Office No 608
                  </p>
                </div>
              </div>
              <div className="mb-8 flex w-full max-w-[370px]">
                ...
                <div className="w-full">
                  ...
                  <p className="text-body-color text-base dark:text-white">
                  +251 902 212 223 , +251 943 151 515
                  </p>
                </div>
              </div>
              <div className="mb-8 flex w-full max-w-[370px]">
              ...
              <form>
                <div className="mb-6">
                  <input
                    ...
                    className="bg-white outline-none border-2 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-600 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  />
                </div>
                <div className="mb-6">
                  <input
                ...
                <div className="mb-6">
                  <textarea
                    ...
                    className="bg-white outline-none border-2 focus:border-blue-500 border-gray-300 rounded-lg text-gray-900 border-[f0f0f0] dark:border-gray-600 focus:border-primary w-full resize-none dark:placeholder-gray-600 py-3 px-[14px] text-base focus-visible:shadow-none"
                  ></textarea>
                </div>
                <div>
                  <button
