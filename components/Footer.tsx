        ...
        <div className="mx-6 py-5 lg:py-10 text-center md:text-left">
          <div className="grid grid-1 justify-items-stretch md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="justify-self-center">
              <h3 className="uppercase dark:text-eternity-500 font-semibold mb-2 lg:mb-4 flex justify-center md:justify-start">
                Useful links
              </h3>
            ...
            <div className="justify-self-center">
              ...
              <p className="flex items-center justify-center md:justify-start mb-2 lg:mb-4 md:dark:text-white">
                <svg
                  aria-hidden="true"
                  focusable="false"
                  data-prefix="fas"
                ...
                >
                  ...
                  Ethiopia, Addis Ababa, Akaki Kality,
                  Sheger Building 6th Floor , Office No 608,
                  infront of kality federal prison.
              </p>
              <p className="flex items-center justify-center md:justify-start mb-2 lg:mb-4 md:dark:text-white">
                <svg
                  aria-hidden="true"
              ...
              <p className="flex items-center justify-center md:justify-start md:dark:text-white">
                <svg
                  aria-hidden="true"
                  focusable="false"
                  data-prefix="fas"
                ...
                +251 114 378 234, +251 114 399 957, +251 114 552 983
              </p>
            </div>
          </div>
        </div>
        <div className="text-center p-6 bg-white dark:bg-gray-900">
          <span className="text-gray-900 dark:text-eternity-500">
            © 2023 Copyright{"  "}
          </span>
          <a
